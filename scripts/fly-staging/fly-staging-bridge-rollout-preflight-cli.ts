...
/**
 * Bridge rollout operator preflight — digest-bound public env + schema compatibility.
...
async function main(): Promise<void> {
  ...
  console.log(`compatibility_mode=${HEADLESS_SCHEMA_PREFLIGHT_ROLLBACK_BRIDGE_007_008_MODE}`);
}

main().catch(() => {
  console.log("fail_class=bridge_rollout_preflight_exception");
  process.exit(1);
});
