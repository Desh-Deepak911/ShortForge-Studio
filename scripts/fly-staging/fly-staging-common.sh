...
FLY_STAGING_GATE_ENV_NAMES="HEADLESS_FLY_STAGING_EXECUTION_AUTHORIZED HEADLESS_FLY_STAGING_AUTHORIZE_APP_CREATE HEADLESS_FLY_STAGING_AUTHORIZE_SECRETS_INSTALL HEADLESS_FLY_STAGING_AUTHORIZE_IMAGE_DEPLOY HEADLESS_FLY_STAGING_AUTHORIZE_BRIDGE_BUILD_ONLY HEADLESS_FLY_STAGING_AUTHORIZE_BRIDGE_ROLLOUT HEADLESS_FLY_STAGING_AUTHORIZE_VERIFY_SCALE_UP HEADLESS_FLY_STAGING_AUTHORIZE_RENDER_SCALE_UP HEADLESS_FLY_STAGING_AUTHORIZE_ROLLBACK HEADLESS_FLY_STAGING_AUTHORIZE_TEARDOWN"
