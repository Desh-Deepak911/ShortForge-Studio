...
fly_staging_isolate_worker_bridge_preflight_env() {
  for _k in UPSTASH_REDIS_REST_URL UPSTASH_REDIS_REST_TOKEN HEADLESS_FLY_RENDER_QA_EXECUTION_PROBE HEADLESS_FLY_RENDER_LIVE_QA HEADLESS_FLY_RENDER_4K_QA; do
    unset "${_k}" 2>/dev/null || true
  done
}
