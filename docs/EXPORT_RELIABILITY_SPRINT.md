...
Contract authority: [`docs/EXPORT_CONTRACT.md`](./EXPORT_CONTRACT.md) — immutable `ExportManifest`, Export Never Breaks, parity invariant, preflight-before-render.
...
- `docs/EXPORT_CONTRACT.md` (accepted after Sprint 6A; required before 6B)  
