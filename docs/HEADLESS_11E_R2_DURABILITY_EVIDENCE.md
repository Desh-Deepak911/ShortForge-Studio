...
| **2C.1B targeted R2 harness** | **IMPLEMENTED** / gate `HEADLESS_R2_QA_TARGETED=1` / evidence `docs/HEADLESS_11E_R2_TARGETED_EVIDENCE.md` / stop-on-first-failure |
...
Evidence: `docs/HEADLESS_11E_R2_LIVE_EVIDENCE.md` (official FAIL archive from pre-2C.1B live run — do not overwrite with gate-off).
...
Targeted evidence: `docs/HEADLESS_11E_R2_TARGETED_EVIDENCE.md`  
Fixture authority note: `docs/HEADLESS_11E_R2_FIXTURE_AUTHORITY_2C1B.md`
