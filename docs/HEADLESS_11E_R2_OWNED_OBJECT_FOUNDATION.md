...
- Evidence: `docs/HEADLESS_11E_NEON_LIVE_EVIDENCE.md`
...
- **Migration identity (2C.1A):** retain `004` — executable catalog IDs are `000,001,002,004`; `003` is non-executable CAS markdown (see `docs/HEADLESS_11E_R2_DURABILITY_EVIDENCE.md`)
