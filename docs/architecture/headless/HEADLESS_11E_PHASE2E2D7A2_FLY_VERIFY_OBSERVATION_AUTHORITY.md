...
- Path: `docs/evidence/headless/archive/HEADLESS_11E_FLY_VERIFY_LIVE_EVIDENCE.pre-2e2d7a2-coverage-fail-0617b7daa538620713d50e6d8c94c9a40434d5d464be6417507bbdb8a4edd292.md`
...
- Writes `docs/evidence/headless/current/HEADLESS_11E_FLY_VERIFY_LIVE_CLEANUP_RECOVERY_EVIDENCE.md` only — never overwrites official live evidence
