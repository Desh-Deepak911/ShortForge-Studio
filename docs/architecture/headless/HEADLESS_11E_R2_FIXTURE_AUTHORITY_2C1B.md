...
Prior official live FAIL (`docs/evidence/headless/current/HEADLESS_11E_R2_LIVE_EVIDENCE.md`, archived as `docs/HEADLESS_11E_R2_LIVE_EVIDENCE.pre-2c1b-*.md`) included `coverage.reconcile` failure from mismatched provisional/upload digest ordering.
...
- Targeted: `docs/evidence/headless/current/HEADLESS_11E_R2_TARGETED_EVIDENCE.md`
- Official live (archive FAIL; do not overwrite): `docs/evidence/headless/current/HEADLESS_11E_R2_LIVE_EVIDENCE.md`
