...
**Started:** 2026-07-20T10:23:09.325Z
**Ended:** 2026-07-20T10:23:41.184Z
**Cleanup:** ok

## Progressive attribution

- lastCompletedRequiredCase=`job.pk_collision_savepoint`
- activeFailedCase=`job.provisional_cas_staging`
...
- `job.provisional_cas_staging`: FAIL category=STAGING_APPEND_FAILED
