...
**Overall:** FAIL
**Eligibility:** NOT ELIGIBLE — failed at process_tree.memory_observation.
**Started:** 2026-07-25T15:31:56.323Z
**Ended:** 2026-07-25T15:41:09.697Z
**Cleanup:** ok
...
- sample_count=2301
- peak_rss_bytes=2547195904
- summed_rss_bytes=174268416
- sampling_complete=false
- oom_or_restart=false
- unavailable_reason=lifecycle_excessive_maximum_gap
- cadence_requested_interval_ms=250
- cadence_average_interval_ms=222
- cadence_maximum_gap_ms=2910
- cadence_completeness_class=excessive_maximum_gap
...
- `process_tree.memory_observation` status=FAIL failure=PROCESS_TREE_MEMORY_INCOMPLETE
- `evidence.privacy` status=NOT_TESTED
