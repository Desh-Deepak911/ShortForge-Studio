...
| Item | Value |
|------|--------|
| Evidence | `docs/archive/sprints/headless/HEADLESS_11E_PHASE2E2D2A_CHROMIUM_SANDBOX_CORRECTION.md` |
| SHA-256 | `0ec713c52236c43b2f64f51b1482a0d8bd0eb0d20c7e8dd5f9d3128150a7d2f9` |
| Archive copy | `docs/archive/sprints/headless/HEADLESS_11E_PHASE2E2D2A_CHROMIUM_SANDBOX_CORRECTION.md` (same SHA) |
...
| Item | Value |
|------|--------|
| Archive | `docs/evidence/headless/archive/HEADLESS_11E_PHASE2E2D3_FLY_SANDBOX_PROBE.pre-account-unlock-FAIL.md` |
