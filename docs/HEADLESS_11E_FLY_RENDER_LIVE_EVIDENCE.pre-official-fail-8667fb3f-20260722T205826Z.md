...
**Overall:** FAIL
**Eligibility:** NOT ELIGIBLE — failed at fly.verify_machine_healthy.
**Started:** 2026-07-22T20:49:09.601Z
**Ended:** 2026-07-22T20:49:25.306Z
**Cleanup:** ok
...
- `env.config`: PASS
- `fly.verify_machine_healthy`: FAIL category=FLY_VERIFY_UNHEALTHY
- `fly.render_machine_healthy`: NOT_TESTED
- `fly.immutable_image_equality`: NOT_TESTED
- `neon.schema_fingerprint`: NOT_TESTED
- `job.create_queued`: NOT_TESTED
