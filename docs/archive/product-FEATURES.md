...
> **Status:** Historical inventory. Current index: [../product/FEATURES.md](../product/FEATURES.md). Workflow: [../product/CREATOR_WORKFLOW.md](../product/CREATOR_WORKFLOW.md).

> Previously: Partially stale in places (limitations and export notes may predate Timeline Intelligence, Audio Mixer v1, and Export Reliability 6B–6F.1). For canonical ownership and freezes, see [MASTER_ARCHITECTURE.md](MASTER_ARCHITECTURE.md).
