...
import type { TransitionEffect, TransitionTimelineItem } from "@/types/footiebitz";
...
export default function TransitionConnector({ item, onUpdate }: TransitionConnectorProps) {
  return (
    <article
