...
export const HEADLESS_FLY_STAGING_POST_008_2G25_CLEANUP_RUNTIME_FINALIZATION_CORRECTION_REJECTED_DEPLOYMENT_PAIR =
  Object.freeze({
    pairId: "post_008_2g25_cleanup_runtime_finalization_correction_rejected_pair",
    role: "rejected_cleanup_runtime",
    imageRecordId:
...
/**
 * Corrected cleanup-runtime — promoted to current forward target (Part
 * 2G.25D Part F.2 Part K) after operational recovery PASS. The sealed
 * rejected pair above is preserved unchanged as historical rejection
 * evidence from Part F; this pair is a new, separate record.
 */
export const HEADLESS_FLY_STAGING_POST_008_2G25_CLEANUP_RUNTIME_FINALIZATION_CORRECTION_CURRENT_DEPLOYMENT_PAIR =
  Object.freeze({
    pairId: "post_008_2g25_cleanup_runtime_finalization_correction_current_pair",
    role: "forward_target",
    imageRecordId: "post_008_2g25_cleanup_runtime_finalization_correction_current",
    imageDigestSha256:
      HEADLESS_FLY_STAGING_CLEANUP_RUNTIME_FINALIZATION_CORRECTION_IMAGE_DIGEST,
    rendererBuildId: HEADLESS_FLY_STAGING_CLEANUP_RUNTIME_RENDERER_BUILD_ID,
    hostedWorkerArtifactSha256:
...
/** @deprecated Prefer HEADLESS_FLY_STAGING_POST_008_2G25_CLEANUP_RUNTIME_FINALIZATION_CORRECTION_REJECTED_DEPLOYMENT_PAIR */
...
export function resolveHeadlessFlyStagingCurrentForwardDeploymentPair(): HeadlessFlyStagingImageEnvironmentDeploymentPair {
  return HEADLESS_FLY_STAGING_POST_008_2G25_CLEANUP_RUNTIME_FINALIZATION_CORRECTION_CURRENT_DEPLOYMENT_PAIR;
}
