...
/** Populated after deterministic local bridge build — not the 2G.24 runtime digest. */
export const HEADLESS_FLY_STAGING_ROLLBACK_BRIDGE_IMAGE_DIGEST =
  HEADLESS_FLY_STAGING_ROLLBACK_BRIDGE_PLACEHOLDER_IMAGE_DIGEST;

export const HEADLESS_FLY_STAGING_ROLLBACK_BRIDGE_HOSTED_WORKER_ARTIFACT_SHA256 =
  "228384fa38c4243b583895ead1c0026c8b3eefc2943c613acf73ab7ca62ac813" as const;
